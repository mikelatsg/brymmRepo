			...
			<div id="detallePedido">
				...
				<div class="well col-md-12">
					<table
						...
						<tbody>
							<tr>
								<td class="titulo col-md-5">Total</td>
								<td class="titulo col-md-5"><?php echo $precioTotal;?><i
									class="fa fa-euro"></i>
								</td>
								<td class="titulo col-md-2">
            ...
            ?>">
				...
				if ($_SESSION['idUsuario']): ?>
					<form method="post"
						...
						<div class="form-group" id="contenidoDireccionEnvio" style="display: none;">
						...
						<!-- <table
							class="table table-condensed table-responsive table-user-information">
							<tr>
								<td class="titulo">Retrasar pedido</td>
							...
							<tr>
								...
								<td><input type="text" name="fechaRecogida"
									id="datepickerFechaRecogidaPedido" /></td>
							</tr>
							<tr>
								<td>hora:</td>
								<td>									
