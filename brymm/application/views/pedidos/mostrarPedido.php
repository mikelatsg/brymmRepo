<div id="mostrarPedido">
    ...
    <div id="formPedido">
        <?php if ($_SESSION['idUsuario']): ?>
            ...
            <form method="post" action="<?php echo site_url() ?>/pedidos/confirmarPedido">
                <input type="hidden" name="idLocal" value="<?php echo $idLocal; ?>">
                <table>
                    <tr>
                        <td><input type="checkbox" name="retrasarPedido" value="1"> Retrasar pedido</td>
                    </tr>
                    <tr>
                        <td>
                            fecha:
                        ...
                        <td>
                            <input type="text" name="fechaRecogida" id="datepickerFechaRecogidaPedido" />
                        </td>
                        <td>
                            hora:
                        </td>
                        <td>
                            ...
                            :
                            <select name="minutoRecogida" id="minutoFechaRecogidaPedido">
                    ...
                    <?php if ($envioPedidos): ?>
                        <tr>
                            <td><input type="checkbox" name="envioPedido" value="1"> Envio pedido</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                Precio envio <? echo $precioEnvioPedido->precio ?>
                            </td>
                        </tr>
                    <?php endif; ?>
                    <tr>
